                        ...
                        <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                            <tr>
                                <td>
                                                                            ...
                                                                            <asp:GridView ID="grdSalesDraft" runat="server" CellPadding="4" AllowPaging="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Customer Code">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lblDCardCode" runat="server" Text='<%#Bind("CardCode")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Customer Name">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lblDCardName" runat="server" Text='<%#Bind("CardName")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Posting Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblDPostDate" runat="server" Text='<%#Bind("DocDate")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Delivery Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblDDelidate" runat="server" Text='<%#Bind("DocDueDate")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Document Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblDTaxDate" runat="server" Text='<%#Bind("TaxDate")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Document Status">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblDstatus" runat="server" Text='<%#Bind("DocStatus")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                                                                            ...
                                                                            <asp:GridView ID="grdDrfLines" runat="server" CellPadding="4" AllowPaging="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Item Code">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lblDLItemCode" runat="server" Text='<%#Bind("ItemCode")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Item Name">
                                                                                        <ItemTemplate>
                                                                                            <div align="center">
                                                                                                <asp:Label ID="lblDLItemName" runat="server" Text='<%#Bind("Dscription")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Quantity">
                                                                                        <ItemTemplate>
                                                                                            <div align="right">
                                                                                                &#160;<asp:Label ID="lblDLQty" runat="server" Text='<%#Bind("Quantity")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Price">
                                                                                        <ItemTemplate>
                                                                                            <div align="right">
                                                                                                &#160;<asp:Label ID="lblDLPrice" runat="server" Text='<%#Bind("Price")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                        <FooterTemplate>
                                                                                            <div align="right">
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Total">
                                                                                        <ItemTemplate>
                                                                                            <div align="right">
                                                                                                &#160;<asp:Label ID="lblDLTotal" runat="server" Text='<%#Bind("LineTotal")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                        <FooterTemplate>
                                                                                            <div align="right">
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="No.of Days">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;&nbsp;<asp:Label ID="lblDdays" runat="server" Text='<%#Bind("U_Z_Noofdays")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Line Status">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblDLstatus" runat="server" Text='<%#Bind("LineStatus")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                                                                                <HeaderStyle HorizontalAlign="Center" Height="25px" BackColor="#CCCCCC" />
                                                                            ...
                                                                            <asp:GridView ID="grdSales" runat="server" CellPadding="4" AllowPaging="True" ShowHeaderWhenEmpty="true"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Customer Code">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                <asp:Label ID="lblCardCode" runat="server" Text='<%#Bind("CardCode")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Customer Name">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                <asp:Label ID="lblCardName" runat="server" Text='<%#Bind("CardName")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Posting Date">
                                                                                        <ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Delivery Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblDelidate" runat="server" Text='<%#Bind("DocDueDate")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Document Date">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblTaxDate" runat="server" Text='<%#Bind("TaxDate")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Document Status">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblstatus" runat="server" Text='<%#Bind("DocStatus")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                                                                                <HeaderStyle HorizontalAlign="Center" Height="25px" BackColor="#CCCCCC" />
                                                                            ...
                                                                            <asp:GridView ID="grdSalesLine" runat="server" CellPadding="4" AllowPaging="True"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Item Code">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                <asp:Label ID="lblLItemCode" runat="server" Text='<%#Bind("ItemCode")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Item Name">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                <asp:Label ID="lblLItemName" runat="server" Text='<%#Bind("Dscription")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="UoM">
                                                                                        <ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Quantity">
                                                                                        <ItemTemplate>
                                                                                            <div align="right">
                                                                                                &#160;<asp:Label ID="lblLQty" runat="server" Text='<%#Bind("Quantity")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Price">
                                                                                        <ItemTemplate>
                                                                                            <div align="right">
                                                                                                &#160;<asp:Label ID="lblLPrice" runat="server" Text='<%#Bind("Price")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                        <FooterTemplate>
                                                                                            <div align="right">
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Total">
                                                                                        <ItemTemplate>
                                                                                            <div align="right">
                                                                                                &#160;<asp:Label ID="lblLTotal" runat="server" Text='<%#Bind("LineTotal")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                        <FooterTemplate>
                                                                                            <div align="right">
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Line Status">
                                                                                        <ItemTemplate>
                                                                                            <div align="left">
                                                                                                &#160;<asp:Label ID="lblLstatus" runat="server" Text='<%#Bind("LineStatus")%>'></asp:Label></div>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                </Columns>
                                                                                <HeaderStyle HorizontalAlign="Center" Height="25px" BackColor="#CCCCCC" />
                                                                                ...
                                                                                <asp:GridView ID="grdSalesItem" runat="server" CellPadding="4" RowStyle-CssClass="mousecursor"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="DocEntry" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;&nbsp;<asp:Label ID="lblDocNo" runat="server" Text='<%#Bind("U_DocEntry")%>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="ItemCode">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;&nbsp;<asp:Label ID="lblItCode" runat="server" Text='<%#Bind("U_ItemCode")%>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="ItemName">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;&nbsp;<asp:Label ID="lblItName" runat="server" Text='<%#Bind("U_ItemName")%>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="No.of Days">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;&nbsp;<asp:Label ID="lbldays" runat="server" Text='<%#Bind("U_LineNodays")%>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Ship to Date" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &#160;&nbsp;<asp:Label ID="lblShpDate" runat="server" Text='<%#Bind("U_ShpDate")%>'></asp:Label></div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                    </Columns>
                                    ...
                                    <asp:Panel ID="PanelSalesOrder" runat="server" BackColor="White" Style="display: none;
                                        padding: 10px; width: 500px;">
                                        <div>
